...
exports.ReciptEmailHtml = exports.ReciptEmail = void 0;
var utils_1 = require("../../lib/utils");
var components_1 = require("@react-email/components");
var date_fns_1 = require("date-fns");
var React = __importStar(require("react"));
var ReciptEmail = function (_a) {
    var email = _a.email, date = _a.date, orderId = _a.orderId, products = _a.products;
    var total = products.reduce(function (acc, curr) { return acc + curr.price; }, 0) + 150;
    return (React.createElement(components_1.Html, null,
        React.createElement(components_1.Head, null),
        React.createElement(components_1.Preview, null, "Your DevCart Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/email-sent.svg"), width: "100", height: "100", alt: "DevCart" })),
...
exports.ReciptEmail = ReciptEmail;
var ReciptEmailHtml = function (props) {
    return (0, components_1.render)(React.createElement(exports.ReciptEmail, __assign({}, props)), {
        pretty: true,
    });
};
exports.ReciptEmailHtml = ReciptEmailHtml;
var main = {
